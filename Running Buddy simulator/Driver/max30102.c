...
#define MAX_VERSION        VERSION_2_   //在这里修改版本定义，VERSION_1_是3点直线的，VERSION_2_是3点错开的
...
void max30102_read_data(void)
{
	  ...
	  static u8 COUNT=8;
		...
		if(COUNT++ >= 5)
		{
					...
					if ((ch_hr_valid == 1) && (n_heart_rate < 150) && (n_heart_rate >= 55))
					{
							hrTimeout = 0;
