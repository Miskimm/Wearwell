...
DATE SysDate = {00, 00, 12, 1,12,1, 25};  //Date: 2025.12.1 Time: 12:00:00 Week: 1
...
void DS1302_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	GPIO_ResetBits(GPIOB, GPIO_Pin_7 | GPIO_Pin_8 | GPIO_Pin_9);//B7,B8,B9初始化为低电平
}
...
/*
计算方法:日期+年份+所过闰年数+月修正数之和除7 的余数就是星期但如果是在
